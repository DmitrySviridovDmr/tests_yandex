...
class TestYandexDisk:
    ...
    def test_get_info_about_disk_user():
        ...
        Checking.check_status_code(result_get, 200)
        Checking.check_fields_json(result_get, ['max_file_size', 'paid_max_file_size', 'total_space', 'trash_size', 'is_paid', 'used_space', 'system_folders', 'user', 'unlimited_autoupload_enabled', 'revision'])
